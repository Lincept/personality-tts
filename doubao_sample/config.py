...
start_session_req = DoubaoRealTimeConfig(
    asr = {
        "extra": {
    ...
    dialog = {
        ...
        "extra": {
            ...
            "audit_response": "审核不通过", # 审核不通过时，返回给用户的回复内容
        }
    }
)
...
mem0_config = Mem0Config(
    ...
    embedder = {
        ...
        "config": {
            ...
            "api_key": os.getenv("MEM0_LLM_API_KEY", ""),
            "openai_base_url": "https://openrouter.ai/api/v1/embeddings",
            "embedding_dims": 1536
        }
    },
    vector_store= {
    ...
    #         "username": "neo4j",
    #         "password": os.getenv("MEM0_GRAPHDB_PASSWD", "")
    #     }
    # }
)