...
def _get_library_path() -> str:
    ...
    if system == 'linux':
        possible_paths = [
            current_dir / 'linux' / arch / 'libwebrtc_apm.so',
            current_dir / 'libwebrtc_apm.so',
        ]
    elif system == 'darwin':
        possible_paths = [
            current_dir / 'macos' / arch / 'libwebrtc_apm.dylib',
            current_dir / 'libwebrtc_apm.dylib',
        ]
    elif system == 'windows':
        possible_paths = [
            current_dir / 'windows' / arch / 'libwebrtc_apm.dll',
            current_dir / 'libwebrtc_apm.dll',
        ]
    else:
